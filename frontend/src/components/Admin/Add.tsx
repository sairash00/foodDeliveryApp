...
const Add = () => {
  ...
  return (
    <div className='w-full flex items-center justify-center py-10 px-[1rem]'>
      <div className='flex flex-col border border-[#fc4e03] gap-8 px-4 py-3 max-w-[70%] max-sm:w-full max-md:w-[80%] shadow-lg rounded-md w-[50%] min-h-[70vh]'>
        <div className='text-2xl max-sm:text-xl text-center font-semibold text-[#fc4e03]'>
          Add Products
        </div>
        <form encType='multipart/form-data' onSubmit={handleSubmit} className='flex flex-col gap-5'>
          <div>
            ...
            <input
              ...
              id='name'
              name='name'
              className='tracking-widest font-semibold border-b text-[#fc4e03] border-[#fc4e0369] focus:border-[#fc4e03] outline-none bg-transparent w-full py-1'
            />
          </div>
          <div>
            <label htmlFor='price' className='text-sm font-semibold tracking-wide'>
              Price *
            </label>
            <input
              value={data.price}
          ...
          <div className='flex flex-col gap-2 mb-2'>
            <label htmlFor='category' className='text-sm font-semibold tracking-wide'>
              Category *
            </label>
            <select
              value={data.category}
          ...
          <label htmlFor='image' className='w-full h-[15vh] border border-[#00000059] rounded-md flex items-center justify-center flex-col'>
            <div className='text-lg flex flex-col items-center hover:text-[gray] transition font-semibold tracking-wide'>
              <FaImage />
              <div className='text-sm font-normal'>Add Image</div>
            </div>
            <input
              type='file'
              disabled={loading}
          ...
          <button
            disabled={loading}
            type='submit'
            className='w-full py-2 bg-[#fc4e03] rounded-md text-white font-semibold transition-all hover:bg-[#bd3a02]'
          >
            {loading ? "Adding..." : "Add"}
          </button>
        </form>
